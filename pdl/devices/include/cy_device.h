...
#if defined(CY_DEVICE_PSC3) || defined(CY_DEVICE_PSC3_P8)
...
#if defined (CY_DEVICE_CYW20829) || defined (CY_DEVICE_PSC3) || defined(CY_DEVICE_PSC3_P8)
...
#define CY_PPCA_SRAM_PPU_ON_MODE                 PPU_V1_MODE_ON
#define CY_PPCA_SRAM_PPU_OFF_MODE                PPU_V1_MODE_OFF
#endif
...
/* Base pointer alias for single-instance PERI devices */
#ifndef PERI0
#define PERI0                   PERI
#endif

#ifndef PERI1
#define PERI1                   ((PERI_Type*)0U)
#endif
...
#define PERI_PERI_PCLK_PCLK_GROUP_NR6_GR_DIV_8_VECT 0
#define PERI_PERI_PCLK_PCLK_GROUP_NR6_GR_DIV_16_VECT 0
#define PERI_PERI_PCLK_PCLK_GROUP_NR6_GR_DIV_16_5_VECT 0
#define PERI_PERI_PCLK_PCLK_GROUP_NR6_GR_DIV_24_5_VECT 0
...
#endif /* CY_DEVICE_PSC3 || CY_DEVICE_PSC3_P8 */
...
#define PERI0_PCLK_GR_NUM_1_CLK_HF_NUM              (0U)
#define PERI0_PCLK_GR_NUM_2_CLK_HF_NUM              (1U)
#define PERI0_PCLK_GR_NUM_3_CLK_HF_NUM              (2U)
#define PERI0_PCLK_GR_NUM_4_CLK_HF_NUM              (3U)
#define PERI0_PCLK_GR_NUM_5_CLK_HF_NUM              (4U)
#define PERI0_PCLK_GR_NUM_6_CLK_HF_NUM              (0U) /* Does not exist on psc3_p8. Kept for BWC */
#else
#define PERI0_PCLK_GR_NUM_0_CLK_HF_NUM              (0U)
...
#define LOAD_PPCA_TRIMS
#endif
#if defined (LOAD_PPCA_TRIMS)

#define SFLASH_SVN_VALUE                    (((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->SFLASH_SVN)
#define SFLASH_SVN_ES100 0x430c2
#define SFLASH_EXTERNAL_VREF_OFFSET     0x258UL
#define SFLASH_EXTERNAL_VREF_DAC_OFFSET 0x270UL /* A 24 byte extra offset to be added for DAC, DCSG1 and DCSG0 (Trim number 2 to 5 ) */
#define SFLASH_DCSG_TRIMS_NUMBER        0UL    /* There are total 6 different trims for DCSG Group0 and 3 different trims for DCSG Group1. */
#define SFLASH_DCSG_TRIM_OFFSET         0x18UL  /* Offset to access different trims in each group. */

#define SFLASH_SAR_INFRA_TRIM_TABLE         (((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->SAR_INFRA_TRIM_TABLE)

/* ADC Group 0 */
#define SFLASH_GRP0_ADC_STARTUPCTRL_VTOICAL_TRIM(offset)   (*(volatile uint32_t*)((uint32_t)(&((((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_ADC_STARTUPCTRL_VTOICAL_TRIM))) + (offset)))
#define SFLASH_GRP0_ADC_CALOFFSET(chNum, offset)           (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_ADC_CALOFFSET[chNum])) + (offset)))
#define SFLASH_GRP0_ADC_CALGAIN_GAINX1(chNum,offset)       (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_ADC_CALGAIN_GAINX1[chNum])) + (offset)))
#define SFLASH_GRP0_AFE_CALGAIN_AFE_1(offset)              (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_AFE_CALGAIN_AFE_1)) + (offset)))
#define SFLASH_GRP0_AFE_CALGAIN_AFE_2(offset)              (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_AFE_CALGAIN_AFE_2)) + (offset)))
#define SFLASH_GRP0_AFE_CALGAIN_AFE_3(offset)              (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_AFE_CALGAIN_AFE_3)) + (offset)))
#define SFLASH_GRP0_AFE_CALGAIN_AFE_4(offset)              (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_AFE_CALGAIN_AFE_4)) + (offset)))
#define SFLASH_GRP0_AFE_CALOFFSET_AFE_1(offset)            (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_AFE_CALOFFSET_AFE_1)) + (offset)))
#define SFLASH_GRP0_AFE_CALOFFSET_AFE_2(offset)            (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_AFE_CALOFFSET_AFE_2)) + (offset)))
#define SFLASH_GRP0_AFE_CALOFFSET_AFE_3(offset)            (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_AFE_CALOFFSET_AFE_3)) + (offset)))
#define SFLASH_GRP0_AFE_CALOFFSET_AFE_4(offset)            (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_AFE_CALOFFSET_AFE_4)) + (offset)))
#define SFLASH_SAR_TEMP_COEF_A                             (((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->SAR_TEMP_COEF_A)
#define SFLASH_SAR_TEMP_COEF_B                             (((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->SAR_TEMP_COEF_B)


/* ADC Group 1 */
#define SFLASH_GRP1_ADC_STARTUPCTRL_VTOICAL_TRIM(offset)   (*(volatile uint32_t*)((uint32_t)(&((((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_ADC_STARTUPCTRL_VTOICAL_TRIM))) + (offset)))
#define SFLASH_GRP1_ADC_CALOFFSET(chNum, offset)           (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_ADC_CALOFFSET[chNum])) + (offset)))
#define SFLASH_GRP1_ADC_CALGAIN_GAINX1(chNum,offset)       (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_ADC_CALGAIN_GAINX1[chNum])) + (offset)))
#define SFLASH_GRP1_AFE_CALGAIN_AFE_1(offset)              (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_AFE_CALGAIN_AFE_1)) + (offset)))
#define SFLASH_GRP1_AFE_CALGAIN_AFE_2(offset)              (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_AFE_CALGAIN_AFE_2)) + (offset)))
#define SFLASH_GRP1_AFE_CALGAIN_AFE_3(offset)              (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_AFE_CALGAIN_AFE_3)) + (offset)))
#define SFLASH_GRP1_AFE_CALGAIN_AFE_4(offset)              (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_AFE_CALGAIN_AFE_4)) + (offset)))
#define SFLASH_GRP1_AFE_CALOFFSET_AFE_1(offset)            (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_AFE_CALOFFSET_AFE_1)) + (offset)))
#define SFLASH_GRP1_AFE_CALOFFSET_AFE_2(offset)            (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_AFE_CALOFFSET_AFE_2)) + (offset)))
#define SFLASH_GRP1_AFE_CALOFFSET_AFE_3(offset)            (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_AFE_CALOFFSET_AFE_3)) + (offset)))
#define SFLASH_GRP1_AFE_CALOFFSET_AFE_4(offset)            (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_AFE_CALOFFSET_AFE_4)) + (offset)))

/* ADC Group 2 */
#define SFLASH_GRP2_ADC_STARTUPCTRL_VTOICAL_TRIM(offset)   (*(volatile uint32_t*)((uint32_t)(&((((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP2_ADC_STARTUPCTRL_VTOICAL_TRIM))) + (offset)))
#define SFLASH_GRP2_ADC_CALOFFSET(chNum, offset)           (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP2_ADC_CALOFFSET[chNum])) + (offset)))
#define SFLASH_GRP2_ADC_CALGAIN_GAINX1(chNum,offset)       (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP2_ADC_CALGAIN_GAINX1[chNum])) + (offset)))
#define SFLASH_GRP2_AFE_CALGAIN_AFE_1(offset)              (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP2_AFE_CALGAIN_AFE_1)) + (offset)))
#define SFLASH_GRP2_AFE_CALGAIN_AFE_2(offset)              (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP2_AFE_CALGAIN_AFE_2)) + (offset)))
#define SFLASH_GRP2_AFE_CALGAIN_AFE_3(offset)              (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP2_AFE_CALGAIN_AFE_3)) + (offset)))
#define SFLASH_GRP2_AFE_CALGAIN_AFE_4(offset)              (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP2_AFE_CALGAIN_AFE_4)) + (offset)))
#define SFLASH_GRP2_AFE_CALOFFSET_AFE_1(offset)            (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP2_AFE_CALOFFSET_AFE_1)) + (offset)))
#define SFLASH_GRP2_AFE_CALOFFSET_AFE_2(offset)            (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP2_AFE_CALOFFSET_AFE_2)) + (offset)))
#define SFLASH_GRP2_AFE_CALOFFSET_AFE_3(offset)            (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP2_AFE_CALOFFSET_AFE_3)) + (offset)))
#define SFLASH_GRP2_AFE_CALOFFSET_AFE_4(offset)            (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP2_AFE_CALOFFSET_AFE_4)) + (offset)))

/* ADC Group 3 */
#define SFLASH_GRP3_ADC_STARTUPCTRL_VTOICAL_TRIM(offset)   (*(volatile uint32_t*)((uint32_t)(&((((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP3_ADC_STARTUPCTRL_VTOICAL_TRIM))) + (offset)))
#define SFLASH_GRP3_ADC_CALOFFSET(chNum, offset)           (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP3_ADC_CALOFFSET[chNum])) + (offset)))
#define SFLASH_GRP3_ADC_CALGAIN_GAINX1(chNum,offset)       (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP3_ADC_CALGAIN_GAINX1[chNum])) + (offset)))
#define SFLASH_GRP3_AFE_CALGAIN_AFE_1(offset)              (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP3_AFE_CALGAIN_AFE_1)) + (offset)))
#define SFLASH_GRP3_AFE_CALGAIN_AFE_2(offset)              (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP3_AFE_CALGAIN_AFE_2)) + (offset)))
#define SFLASH_GRP3_AFE_CALGAIN_AFE_3(offset)              (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP3_AFE_CALGAIN_AFE_3)) + (offset)))
#define SFLASH_GRP3_AFE_CALGAIN_AFE_4(offset)              (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP3_AFE_CALGAIN_AFE_4)) + (offset)))
#define SFLASH_GRP3_AFE_CALOFFSET_AFE_1(offset)            (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP3_AFE_CALOFFSET_AFE_1)) + (offset)))
#define SFLASH_GRP3_AFE_CALOFFSET_AFE_2(offset)            (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP3_AFE_CALOFFSET_AFE_2)) + (offset)))
#define SFLASH_GRP3_AFE_CALOFFSET_AFE_3(offset)            (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP3_AFE_CALOFFSET_AFE_3)) + (offset)))
#define SFLASH_GRP3_AFE_CALOFFSET_AFE_4(offset)            (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP3_AFE_CALOFFSET_AFE_4)) + (offset)))

#define SFLASH_GRP0_DCSG_TEST_VREF_TRIM(offset)                    (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_DCSG_TEST_VREF_TRIM)) + (offset)))
#define SFLASH_GRP0_DCSG_DIFF_CALOFFSET(offset)                    (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_DCSG_DIFF_CALOFFSET)) + (offset)))
#define SFLASH_GRP0_DCSG_SE_CALOFFSET(offset)                      (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_DCSG_SE_CALOFFSET)) + (offset)))
#define SFLASH_GRP0_DCSG_DIFF_CALGAIN_1(offset)                    (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_DCSG_DIFF_CALGAIN_1)) + (offset)))
#define SFLASH_GRP0_DCSG_DIFF_CALGAIN_2(offset)                    (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_DCSG_DIFF_CALGAIN_2)) + (offset)))
#define SFLASH_GRP0_DCSG_SE_CALGAIN(offset)                        (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_DCSG_SE_CALGAIN)) + (offset)))

#define SFLASH_GRP0_DAC_OFFSET_CNFG1(offset)                       (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_DAC_OFFSET_CNFG1)) + (offset)))  /* 16 bit */
#define SFLASH_GRP0_DAC_OFFSET_CNFG2(offset)                       (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_DAC_OFFSET_CNFG2)) + (offset)))  /* 16 bit */
#define SFLASH_GRP0_DAC_OFFSET_CNFG3(offset)                       (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_DAC_OFFSET_CNFG3)) + (offset)))  /* 16 bit */
#define SFLASH_GRP0_DAC_OFFSET_CNFG4(offset)                       (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_DAC_OFFSET_CNFG4)) + (offset)))  /* 16 bit */
#define SFLASH_GRP0_DAC_OFFSET_CNFG5(offset)                       (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_DAC_OFFSET_CNFG5)) + (offset)))  /* 16 bit */

#define SFLASH_GRP0_DAC_GAIN_CNFG1(offset)                         (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_DAC_GAIN_CNFG1)) + (offset)))  /* 16 bit */
#define SFLASH_GRP0_DAC_GAIN_CNFG2(offset)                         (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_DAC_GAIN_CNFG2)) + (offset)))  /* 16 bit */
#define SFLASH_GRP0_DAC_GAIN_CNFG3(offset)                         (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_DAC_GAIN_CNFG3)) + (offset)))  /* 16 bit */
#define SFLASH_GRP0_DAC_GAIN_CNFG4(offset)                         (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_DAC_GAIN_CNFG4)) + (offset)))  /* 16 bit */
#define SFLASH_GRP0_DAC_GAIN_CNFG5(offset)                         (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_DAC_GAIN_CNFG5)) + (offset)))  /* 16 bit */

#define SFLASH_GRP0_BUFFER_OFFSET_1(offset)                        (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_BUFFER_OFFSET_1)) + (offset)))  /* 16 bit */
#define SFLASH_GRP0_BUFFER_OFFSET_2(offset)                        (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP0_BUFFER_OFFSET_2)) + (offset)))  /* 16 bit */

#define SFLASH_GRP1_DCSG_TEST_VREF_TRIM(offset)                    (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_DCSG_TEST_VREF_TRIM)) + (offset)))
#define SFLASH_GRP1_DCSG_DIFF_CALOFFSET(offset)                    (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_DCSG_DIFF_CALOFFSET)) + (offset)))
#define SFLASH_GRP1_DCSG_SE_CALOFFSET(offset)                      (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_DCSG_SE_CALOFFSET)) + (offset)))
#define SFLASH_GRP1_DCSG_DIFF_CALGAIN_1(offset)                    (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_DCSG_DIFF_CALGAIN_1)) + (offset)))
#define SFLASH_GRP1_DCSG_DIFF_CALGAIN_2(offset)                    (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_DCSG_DIFF_CALGAIN_2)) + (offset)))
#define SFLASH_GRP1_DCSG_SE_CALGAIN(offset)                        (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_DCSG_SE_CALGAIN)) + (offset)))

#define SFLASH_GRP1_DAC_OFFSET_CNFG1(offset)                       (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_DAC_OFFSET_CNFG1)) + (offset)))  /* 16 bit */
#define SFLASH_GRP1_DAC_OFFSET_CNFG2(offset)                       (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_DAC_OFFSET_CNFG2)) + (offset)))  /* 16 bit */
#define SFLASH_GRP1_DAC_OFFSET_CNFG3(offset)                       (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_DAC_OFFSET_CNFG3)) + (offset)))  /* 16 bit */
#define SFLASH_GRP1_DAC_OFFSET_CNFG4(offset)                       (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_DAC_OFFSET_CNFG4)) + (offset)))  /* 16 bit */
#define SFLASH_GRP1_DAC_OFFSET_CNFG5(offset)                       (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_DAC_OFFSET_CNFG5)) + (offset)))  /* 16 bit */

#define SFLASH_GRP1_DAC_GAIN_CNFG1(offset)                         (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_DAC_GAIN_CNFG1)) + (offset)))  /* 16 bit */
#define SFLASH_GRP1_DAC_GAIN_CNFG2(offset)                         (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_DAC_GAIN_CNFG2)) + (offset)))  /* 16 bit */
#define SFLASH_GRP1_DAC_GAIN_CNFG3(offset)                         (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_DAC_GAIN_CNFG3)) + (offset)))  /* 16 bit */
#define SFLASH_GRP1_DAC_GAIN_CNFG4(offset)                         (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_DAC_GAIN_CNFG4)) + (offset)))  /* 16 bit */
#define SFLASH_GRP1_DAC_GAIN_CNFG5(offset)                         (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_DAC_GAIN_CNFG5)) + (offset)))  /* 16 bit */

#define SFLASH_GRP1_BUFFER_OFFSET_1(offset)                        (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_BUFFER_OFFSET_1)) + (offset)))  /* 16 bit */
#define SFLASH_GRP1_BUFFER_OFFSET_2(offset)                        (*(volatile uint32_t*)((uint32_t)(&(((SFLASH_Type *) CY_SFLASH_NS_SBUS_BASE)->GRP1_BUFFER_OFFSET_2)) + (offset)))  /* 16 bit */
...
#define CY_TCPWM_GF_PRESENT             1U
#else
/* CY_DEVICE_PSC3_P8 we don't have Glitch Filters both in TCPWM inside PPCA and TCPWM outside PPCA */
#define CY_TCPWM_GF_PRESENT             0U
#endif
...
#if defined(CY_DEVICE_PSC3_P8)
#define TCPWM_GRP_DITHERING_REQUIRED     0U
#define TCPWM_GRP_DITHERING_PRESENT(grp) 0U
#define TCPWM_GRP_HRPWM_PRESENT(base, grp) (((((base) == ((TCPWM_Type*)PPCA_TCPWM0)) || ((base) == ((TCPWM_Type*)PPCA_TCPWM1))) && (((grp) == 0UL) || ((grp) == 1UL))) ? 1U : 0U)
...
#define CY_PPU_PPCA_SRAM0_BASE                       ((uint32_t)PPCA_CPUSS_CNFG_RAMC_PPU0)
#define CY_PPU_PPCA_SRAM1_BASE                       ((uint32_t)PPCA_CPUSS_CNFG_RAMC_PPU1)
#define CY_PPU_PPCA_SRAM2_BASE                       ((uint32_t)PPCA_CPUSS_CNFG_RAMC_PPU2)
#define CY_PPU_PPCA_SRAM3_BASE                       ((uint32_t)PPCA_CPUSS_CNFG_RAMC_PPU3)
#define CY_PPU_PPCA_SRAM4_BASE                       ((uint32_t)PPCA_CPUSS_CNFG_RAMC_PPU4)
#endif
...
#if defined (CY_IP_MXS40PPSS)
#define CY_PPCA_IPC_STRUCT_PTR(ipcIndex)            (&(((IPC_Type *)PPCA_IPC0)->STRUCT[ipcIndex]))
#define CY_PPCA_IPC_INTR_STRUCT_PTR(ipcIntrIndex)   (&(((IPC_Type *)PPCA_IPC0)->INTR_STRUCT[ipcIntrIndex]))

#define CY_PPCA_IPC_INSTANCES                       (1U)
#define CY_PPCA_IPC_CHANNELS                        (4U)
#define CY_PPCA_IPC_INTERRUPTS                      (4U)
#define CY_PPCA_IPC_CHANNELS_PER_INSTANCE           CY_IPC_CHANNELS
#define CY_PPCA_IPC_INTERRUPTS_PER_INSTANCE         CY_IPC_INTERRUPTS
...
#define CY_IPC_INTR_MUX(intrIndex)      (ppca_ipc_0_IRQn + intrIndex)
#define cpuss_interrupts_ipc_0_IRQn     ppca_ipc_0_IRQn
#define cpuss_interrupts_ipc_1_IRQn     ppca_ipc_1_IRQn
#else
...
#elif defined(CY_DEVICE_PSC3_P8)
#define PPC_VALIDATE(ipInst, regionID)                  ((((ipInst) == PPC) && ((regionID) <= (uint32_t)PROT_PPCA_ATOPSS_ATOPSS))? true : false)
#else
...
*            PPCA CORES
*******************************************************************************/
#if !defined PPCA_CPUSS_CNFG_MXCM331
#define PPCA_CORE1_WOUNDING_ENABLED
#endif
...
#define PPCA_EPU_CTRL(base)                                      (((PPCA_EPU_Type *)(base))->CTRL)

#define PPCA_EPU_EPU_PU_T1_CNFG(base, idx)                       (((PPCA_EPU_EPU_Type *)(base))->PU_T1_CNFG[idx])
#define PPCA_EPU_EPU_PU_T2_CNFG(base, idx)                       (((PPCA_EPU_EPU_Type *)(base))->PU_T2_CNFG[idx])
#define PPCA_EPU_EPU_COMBO_CNFG(base, idx)                       (((PPCA_EPU_EPU_Type *)(base))->COMBO_CNFG[idx])
#define PPCA_EPU_EPU_COMBO_FB_CNFG(base, idx)                    (((PPCA_EPU_EPU_Type *)(base))->COMBO_FB_CNFG[idx])

#define PPCA_EPU_EPU_IRQ_INTR_SRCSEL(base)                       (((PPCA_EPU_EPU_IRQ_Type *)(base))->INTR_SRCSEL)
#define PPCA_EPU_EPU_IRQ_INTR(base)                              (((PPCA_EPU_EPU_IRQ_Type *)(base))->INTR)
#define PPCA_EPU_EPU_IRQ_INTR_SET(base)                          (((PPCA_EPU_EPU_IRQ_Type *)(base))->INTR_SET)
#define PPCA_EPU_EPU_IRQ_INTR_MASK(base)                         (((PPCA_EPU_EPU_IRQ_Type *)(base))->INTR_MASK)
#define PPCA_EPU_EPU_IRQ_INTR_MASKED(base)                       (((PPCA_EPU_EPU_IRQ_Type *)(base))->INTR_MASKED)

/*******************************************************************************
*            PPCA CNFG
*******************************************************************************/
#define PPCA_CNFG_CTRL(base)                                (((PPCA_CNFG_Type *)(base))->CTRL)

#define PPCA_CNFG_CNFG_CNFG0(base)                          (((PPCA_CNFG_CNFG_Type *)(base))->CNFG0)
#define PPCA_CNFG_CNFG_CNFG1(base)                          (((PPCA_CNFG_CNFG_Type *)(base))->CNFG1)
#define PPCA_CNFG_CNFG_CNFG2(base)                          (((PPCA_CNFG_CNFG_Type *)(base))->CNFG2)
#define PPCA_CNFG_CNFG_CNFG_TRACE_ATOP(base)                (((PPCA_CNFG_CNFG_Type *)(base))->CNFG_TRACE_ATOP)
#define PPCA_CNFG_CNFG_CPU_CTRL(base)                       (((PPCA_CNFG_CNFG_Type *)(base))->CPU_CTRL)
#define PPCA_CNFG_CNFG_RST_CTRL(base)                       (((PPCA_CNFG_CNFG_Type *)(base))->RST_CTRL)
#define PPCA_CNFG_CNFG_PPCAIN_SEL(base, idx)                (((PPCA_CNFG_CNFG_Type *)(base))->PPCAIN_SEL[idx])
#define PPCA_CNFG_CNFG_TR_PPCAIN_SEL(base, idx)             (((PPCA_CNFG_CNFG_Type *)(base))->TR_PPCAIN_SEL[idx])
#define PPCA_CNFG_CNFG_PPCAOUT_SEL(base)                    (((PPCA_CNFG_CNFG_Type *)(base))->PPCAOUT_SEL)
#define PPCA_CNFG_CNFG_DDFTOUT_SEL(base, idx)               (((PPCA_CNFG_CNFG_Type *)(base))->DDFTOUT_SEL[idx])
#define PPCA_CNFG_CNFG_PPCAIO_IN_MON(base)                  (((PPCA_CNFG_CNFG_Type *)(base))->PPCAIO_IN_MON)
#define PPCA_CNFG_CNFG_SCRATCH0(base)                       (((PPCA_CNFG_CNFG_Type *)(base))->SCRATCH0)
#define PPCA_CNFG_CNFG_SCRATCH1(base)                       (((PPCA_CNFG_CNFG_Type *)(base))->SCRATCH1)

#define PPCA_CNFG_S2IRQ_INTR(base)                          (((PPCA_CNFG_S2IRQ_Type *)(base))->INTR)
#define PPCA_CNFG_S2IRQ_INTR_SET(base)                      (((PPCA_CNFG_S2IRQ_Type *)(base))->INTR_SET)
#define PPCA_CNFG_S2IRQ_INTR_MASK(base)                     (((PPCA_CNFG_S2IRQ_Type *)(base))->INTR_MASK)
#define PPCA_CNFG_S2IRQ_INTR_MASKED(base)                   (((PPCA_CNFG_S2IRQ_Type *)(base))->INTR_MASKED)

#define PPCA_CNFGPPCA_CNFG_DISPERI_DISPERI(base)            (((PPCA_CNFG_DISPERI_Type *)(base))->DISPERI)


/*******************************************************************************
*            HWFILT3P3Z
*******************************************************************************/
#define PPCA_HWFILT3P3Z_SS_Type                         PPCA_HWFILT3P3Z_SS_0_Type
#define PPCA_HWFILT3P3Z_SS_HWFILT3P3Z_Type              PPCA_HWFILT3P3Z_SS_0_HWFILT3P3Z_Type

#define PPCA_HWFILT3P3Z_CTRL(base)                      (((PPCA_HWFILT3P3Z_SS_Type *)(base))->CTRL)

#define PPCA_HWFILT3P3Z_SS_CTRL(base)                   (((PPCA_HWFILT3P3Z_SS_HWFILT3P3Z_Type *)(base))->CTRL)
#define PPCA_HWFILT3P3Z_SS_DATA_IN0(base)               (((PPCA_HWFILT3P3Z_SS_HWFILT3P3Z_Type *)(base))->DATA_IN0)
#define PPCA_HWFILT3P3Z_SS_DATA_IN1(base)               (((PPCA_HWFILT3P3Z_SS_HWFILT3P3Z_Type *)(base))->DATA_IN1)
#define PPCA_HWFILT3P3Z_SS_CNFG(base)                   (((PPCA_HWFILT3P3Z_SS_HWFILT3P3Z_Type *)(base))->CNFG)
#define PPCA_HWFILT3P3Z_SS_CX0(base)                    (((PPCA_HWFILT3P3Z_SS_HWFILT3P3Z_Type *)(base))->CX0)
#define PPCA_HWFILT3P3Z_SS_CX1(base)                    (((PPCA_HWFILT3P3Z_SS_HWFILT3P3Z_Type *)(base))->CX1)
#define PPCA_HWFILT3P3Z_SS_CX2(base)                    (((PPCA_HWFILT3P3Z_SS_HWFILT3P3Z_Type *)(base))->CX2)
#define PPCA_HWFILT3P3Z_SS_CX3(base)                    (((PPCA_HWFILT3P3Z_SS_HWFILT3P3Z_Type *)(base))->CX3)
#define PPCA_HWFILT3P3Z_SS_CY1(base)                    (((PPCA_HWFILT3P3Z_SS_HWFILT3P3Z_Type *)(base))->CY1)
#define PPCA_HWFILT3P3Z_SS_CY2(base)                    (((PPCA_HWFILT3P3Z_SS_HWFILT3P3Z_Type *)(base))->CY2)
#define PPCA_HWFILT3P3Z_SS_CY3(base)                    (((PPCA_HWFILT3P3Z_SS_HWFILT3P3Z_Type *)(base))->CY3)
#define PPCA_HWFILT3P3Z_SS_DATA_OUT(base)               (((PPCA_HWFILT3P3Z_SS_HWFILT3P3Z_Type *)(base))->DATA_OUT)
#define PPCA_HWFILT3P3Z_SS_OFFSET(base)                 (((PPCA_HWFILT3P3Z_SS_HWFILT3P3Z_Type *)(base))->OFFSET)
#define PPCA_HWFILT3P3Z_SS_LIMMAX(base)                 (((PPCA_HWFILT3P3Z_SS_HWFILT3P3Z_Type *)(base))->LIMMAX)
#define PPCA_HWFILT3P3Z_SS_LIMMIN(base)                 (((PPCA_HWFILT3P3Z_SS_HWFILT3P3Z_Type *)(base))->LIMMIN)
#define PPCA_HWFILT3P3Z_SS_SCALECX(base)                (((PPCA_HWFILT3P3Z_SS_HWFILT3P3Z_Type *)(base))->SCALECX)
#define PPCA_HWFILT3P3Z_SS_SCALECY(base)                (((PPCA_HWFILT3P3Z_SS_HWFILT3P3Z_Type *)(base))->SCALECY)
#define PPCA_HWFILT3P3Z_SS_GIN(base)                    (((PPCA_HWFILT3P3Z_SS_HWFILT3P3Z_Type *)(base))->GIN)
#define PPCA_HWFILT3P3Z_SS_GOUT(base)                   (((PPCA_HWFILT3P3Z_SS_HWFILT3P3Z_Type *)(base))->GOUT)
...
#define PPCA_CLB_CTRL(base)                                (((PPCA_CLB_Type *)(base))->CTRL)

#define PPCA_CLB_DICO_CTRL(base)                           (((PPCA_CLB_DICO_Type *)(base))->CTRL)
#define PPCA_CLB_DICO_CNFG(base)                           (((PPCA_CLB_DICO_Type *)(base))->CNFG)
#define PPCA_CLB_DICO_EVENT(base)                          (((PPCA_CLB_DICO_Type *)(base))->EVENT)
#define PPCA_CLB_DICO_SAFE(base)                           (((PPCA_CLB_DICO_Type *)(base))->SAFE)
#define PPCA_CLB_DICO_IMAXL(base)                          (((PPCA_CLB_DICO_Type *)(base))->IMAXL)
#define PPCA_CLB_DICO_IMINL(base)                          (((PPCA_CLB_DICO_Type *)(base))->IMINL)
#define PPCA_CLB_DICO_VAC_POL(base)                        (((PPCA_CLB_DICO_Type *)(base))->VAC_POL)
#define PPCA_CLB_DICO_OBS_CTRL(base)                       (((PPCA_CLB_DICO_Type *)(base))->OBS_CTRL)
#define PPCA_CLB_DICO_PERIOD_MEAS(base, idx)               (((PPCA_CLB_DICO_Type *)(base))->PERIOD_MEAS[idx])
#define PPCA_CLB_DICO_IEST_IND_ACCU(base, idx)             (((PPCA_CLB_DICO_Type *)(base))->IEST_IND_ACCU[idx])
#define PPCA_CLB_DICO_IL_ACCU(base, idx)                   (((PPCA_CLB_DICO_Type *)(base))->IL_ACCU[idx])
#define PPCA_CLB_DICO_IEST_CORR(base, idx)                 (((PPCA_CLB_DICO_Type *)(base))->IEST_CORR[idx])
#define PPCA_CLB_DICO_PE_IMINL(base)                       (((PPCA_CLB_DICO_Type *)(base))->PE_IMINL)
#define PPCA_CLB_DICO_PE_IMAXL(base)                       (((PPCA_CLB_DICO_Type *)(base))->PE_IMAXL)
#define PPCA_CLB_DICO_PE_UP_COUNT(base)                    (((PPCA_CLB_DICO_Type *)(base))->PE_UP_COUNT)
#define PPCA_CLB_DICO_PE_DN_COUNT(base)                    (((PPCA_CLB_DICO_Type *)(base))->PE_DN_COUNT)
#define PPCA_CLB_DICO_PE_TPHD_1(base)                      (((PPCA_CLB_DICO_Type *)(base))->PE_TPHD_1)
#define PPCA_CLB_DICO_PE_TPHD_2(base)                      (((PPCA_CLB_DICO_Type *)(base))->PE_TPHD_2)
#define PPCA_CLB_DICO_PS_TH(base)                          (((PPCA_CLB_DICO_Type *)(base))->PS_TH)
#define PPCA_CLB_DICO_PS_CC_INFO(base, idx)                (((PPCA_CLB_DICO_Type *)(base))->PS_CC_INFO[idx])
#define PPCA_CLB_DICO_PS_CC(base, idx)                     (((PPCA_CLB_DICO_Type *)(base))->PS_CC[idx])
#define PPCA_CLB_DICO_INTR(base)                           (((PPCA_CLB_DICO_Type *)(base))->INTR)
#define PPCA_CLB_DICO_INTR_SET(base)                       (((PPCA_CLB_DICO_Type *)(base))->INTR_SET)
#define PPCA_CLB_DICO_INTR_MASK(base)                      (((PPCA_CLB_DICO_Type *)(base))->INTR_MASK)
#define PPCA_CLB_DICO_INTR_MASKED(base)                    (((PPCA_CLB_DICO_Type *)(base))->INTR_MASKED)
#define PPCA_CLB_DICO_PCO_CORR_IEST(base, idx)             (((PPCA_CLB_DICO_Type *)(base))->PCO_CORR_IEST[idx])
#define PPCA_CLB_DICO_STAT(base)                           (((PPCA_CLB_DICO_Type *)(base))->STAT)

#define PPCA_CLB_MACO_CTRL(base)                           (((PPCA_CLB_MACO_Type *)(base))->CTRL)
#define PPCA_CLB_MACO_EVENT(base)                          (((PPCA_CLB_MACO_Type *)(base))->EVENT)
#define PPCA_CLB_MACO_STAT(base)                           (((PPCA_CLB_MACO_Type *)(base))->STAT)
#define PPCA_CLB_MACO_SECT0_ROW(base)                      (((PPCA_CLB_MACO_Type *)(base))->SECT0_ROW)
#define PPCA_CLB_MACO_SECT1_ROW(base)                      (((PPCA_CLB_MACO_Type *)(base))->SECT1_ROW)
#define PPCA_CLB_MACO_SECT2_ROW(base)                      (((PPCA_CLB_MACO_Type *)(base))->SECT2_ROW)
#define PPCA_CLB_MACO_INTR(base)                           (((PPCA_CLB_MACO_Type *)(base))->INTR)
#define PPCA_CLB_MACO_INTR_SET(base)                       (((PPCA_CLB_MACO_Type *)(base))->INTR_SET)
#define PPCA_CLB_MACO_INTR_MASK(base)                      (((PPCA_CLB_MACO_Type *)(base))->INTR_MASK)
#define PPCA_CLB_MACO_INTR_MASKED(base)                    (((PPCA_CLB_MACO_Type *)(base))->INTR_MASKED)
#define PPCA_CLB_MACO_SECT0_PATTERN(base, idx)             (((PPCA_CLB_MACO_Type *)(base))->SECT0_PATTERN[idx])
#define PPCA_CLB_MACO_SECT0_SAFE(base)                     (((PPCA_CLB_MACO_Type *)(base))->SECT0_SAFE)
#define PPCA_CLB_MACO_SECT1_PATTERN(base, idx)             (((PPCA_CLB_MACO_Type *)(base))->SECT1_PATTERN[idx])
#define PPCA_CLB_MACO_SECT1_SAFE(base)                     (((PPCA_CLB_MACO_Type *)(base))->SECT1_SAFE)
#define PPCA_CLB_MACO_SECT2_PATTERN(base, idx)             (((PPCA_CLB_MACO_Type *)(base))->SECT2_PATTERN[idx])
#define PPCA_CLB_MACO_SECT2_SAFE(base)                     (((PPCA_CLB_MACO_Type *)(base))->SECT2_SAFE)

/*******************************************************************************
*            PPCA ATOP ADC
*******************************************************************************/
#define PPCA_ATOP_ADC_SARINITSE_OFFSET                 0x108
#define PPCA_ATOP_ADC_SARINITDIFF_OFFSET               0x10C
#define PPCA_ATOP_ADC_CONVCTRL_OFFSET                  0x110
#define PPCA_ATOP_ADC_CALOFFSET_OFFSET(ch_num)         ((0x120UL) + (ch_num * 4UL))
#define PPCA_ATOP_ADC_CALGAIN_OFFSET(ch_num)           ((0x160UL) + (ch_num * 4UL))
#define PPCA_ATOP_ADC_CALTIMING_OFFSET                 0x1A0
#define PPCA_ATOP_ADC_STATUS_OFFSET                    0x1A4
#define PPCA_ATOP_ADC_DATA_TEST_OFFSET                 0x1A8

#define PPCA_GET_ADC_GROUP_NUMBER(base) (((base) == PPCA_ATOPSS_ADC_GRP0_SLICE0_ADC)? 0U : (((base) == PPCA_ATOPSS_ADC_GRP1_SLICE0_ADC)? 1U : (((base) == PPCA_ATOPSS_ADC_GRP2_SLICE0_ADC) ? 2U : 3U)))

#define PPCA_ATOP_ADC_CTRL(base)                                (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_CTL)
#define PPCA_ATOP_ADC_CNFG(base)                                (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_CNFG)
#define PPCA_ATOP_ADC_AUX_CNFG(base)                            (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_AUX_ALT_AUX_CNFG)
#define PPCA_ATOP_ADC_CNV_CNFG(base)                            (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_CNV_CNFG)
#define PPCA_ATOP_ADC_SAMPLING_MASK(base)                       (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_SAMPLING_MASK)
#define PPCA_ATOP_ADC_TRIGGER(base)                             (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_TRIGGER)
#define PPCA_ATOP_ADC_CH_CNFG0(base)                            (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_CH_CNFG0)
#define PPCA_ATOP_ADC_CH_CNFG1(base)                            (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_CH_CNFG1)
#define PPCA_ATOP_ADC_CH_CNFG2(base)                            (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_CH_CNFG2)
#define PPCA_ATOP_ADC_CH_CNFG3(base)                            (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_CH_CNFG3)
#define PPCA_ATOP_ADC_AUX_CH_CNFG0(base)                        (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_AUX_CH_CNFG0)
#define PPCA_ATOP_ADC_AUX_CH_CNFG1(base)                        (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_AUX_CH_CNFG1)
#define PPCA_ATOP_ADC_ALT_AUX_CH_CNFG(base)                     (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_ALT_AUX_CH_CNFG)
#define PPCA_ATOP_ADC_DATA(base, ch_num)                        (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_DATA[ch_num])
#define PPCA_ATOP_ADC_AUX_DATA(base, ch_num)                    (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_AUX_DATA[ch_num])
#define PPCA_ATOP_ADC_ALT_AUX_DATA(base, ch_num)                (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_ALT_AUX_DATA[ch_num])
#define PPCA_ATOP_ADC_INTR(base)                                (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_INTR)
#define PPCA_ATOP_ADC_INTR_SET(base)                            (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_INTR_SET)
#define PPCA_ATOP_ADC_INTR_MASK(base)                           (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_INTR_MASK)
#define PPCA_ATOP_ADC_INTR_MASKED(base)                         (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_INTR_MASKED)
#define PPCA_ATOP_ADC_SIGN_UNSIGN_CNFG(base)                    (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_SIGN_UNSIGN_CNFG)
#define PPCA_ATOP_ADC_AUX_SIGN_UNSIGN_CNFG(base)                (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->AUX_SIGN_UNSIGN_CNFG)
#define PPCA_ATOP_ADC_AUX_ALT_SIGN_UNSIGN_CNFG(base)            (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->AUX_ALT_SIGN_UNSIGN_CNFG)
#define PPCA_ATOP_ADC_STARTUPCTRL(base)                         (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_STARTUPCTRL)
#define PPCA_ATOP_ADC_CALCTRL(base)                             (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_CALCTRL)
#define PPCA_ATOP_ADC_CALTIMING(base)                           (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_CALTIMING)
#define PPCA_ATOP_ADC_STATUS(base)                              (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_STATUS)
#define PPCA_ATOP_ADC_CALOFFSET(base, ch_num)                   (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_CALOFFSET[ch_num])
#define PPCA_ATOP_ADC_CALGAIN(base, ch_num)                     (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_CALGAIN[ch_num])
#define PPCA_ATOP_ADC_DFT_AUX_CNFG(base)                       (((PPCA_ATOPSS_ADC_GRP_SLICE_ADC_Type *)(base))->ADC_DFT_AUX_CNFG)

/*******************************************************************************
*            PPCA ADCM (ADC Mirror)
*******************************************************************************/
#define PPCA_ADCM_DATA(base, index)                             (((PPCA_ADCM_ADCM_Type *)(base))->ADC_DATA[index])

/*******************************************************************************
*            PPCA ATOP AFE
*******************************************************************************/
#define PPCA_ATOP_AFE_OFFSET 0x200
#define PPCA_GET_AFE_GROUP_NUMBER(base) (((base) == PPCA_ATOPSS_ADC_GRP0_SLICE0_AFE)? 0U : (((base) == PPCA_ATOPSS_ADC_GRP1_SLICE0_AFE)? 1U : (((base) == PPCA_ATOPSS_ADC_GRP2_SLICE0_AFE) ? 2U : 3U)))
#define PPCA_ATOP_AFE_CTL(base)                                (((PPCA_ATOPSS_ADC_GRP_SLICE_AFE_Type *)(base))->AFE_CTL)
#define PPCA_ATOP_AFE_CNFG(base)                               (((PPCA_ATOPSS_ADC_GRP_SLICE_AFE_Type *)(base))->AFE_CNFG)
#define PPCA_ATOP_AFE_CALGAINAFE_1(base)                       (((PPCA_ATOPSS_ADC_GRP_SLICE_AFE_Type *)(base))->AFE_CALGAINAFE_1)
#define PPCA_ATOP_AFE_CALGAINAFE_2(base)                       (((PPCA_ATOPSS_ADC_GRP_SLICE_AFE_Type *)(base))->AFE_CALGAINAFE_2)
#define PPCA_ATOP_AFE_CALGAINAFE_3(base)                       (((PPCA_ATOPSS_ADC_GRP_SLICE_AFE_Type *)(base))->AFE_CALGAINAFE_3)
#define PPCA_ATOP_AFE_CALGAINAFE_4(base)                       (((PPCA_ATOPSS_ADC_GRP_SLICE_AFE_Type *)(base))->AFE_CALGAINAFE_4)
#define PPCA_ATOP_AFE_CALOFFSETAFE_1(base)                       (((PPCA_ATOPSS_ADC_GRP_SLICE_AFE_Type *)(base))->AFE_CALOFFSETAFE_1)
#define PPCA_ATOP_AFE_CALOFFSETAFE_2(base)                       (((PPCA_ATOPSS_ADC_GRP_SLICE_AFE_Type *)(base))->AFE_CALOFFSETAFE_2)
#define PPCA_ATOP_AFE_CALOFFSETAFE_3(base)                       (((PPCA_ATOPSS_ADC_GRP_SLICE_AFE_Type *)(base))->AFE_CALOFFSETAFE_3)
#define PPCA_ATOP_AFE_CALOFFSETAFE_4(base)                       (((PPCA_ATOPSS_ADC_GRP_SLICE_AFE_Type *)(base))->AFE_CALOFFSETAFE_4)

/*******************************************************************************
*            PPCA ATOP ADC FILTER
*******************************************************************************/

#define PPCA_ATOP_AFLT_CTL(base)                                (((PPCA_ATOPSS_ADC_GRP_AFLT_Type *)(base))->AFLT_CTL)
#define PPCA_ATOP_AFLT_CNFG(base)                               (((PPCA_ATOPSS_ADC_GRP_AFLT_Type *)(base))->AFLT_CNFG)
#define PPCA_ATOP_AFLT_LPF_ALFA(base)                           (((PPCA_ATOPSS_ADC_GRP_AFLT_Type *)(base))->LPF_ALFA)
#define PPCA_ATOP_AFLT_LPF_DOUT(base)                           (((PPCA_ATOPSS_ADC_GRP_AFLT_Type *)(base))->LPF_DOUT)
#define PPCA_ATOP_AFLT_CICF_CNFG(base)                          (((PPCA_ATOPSS_ADC_GRP_AFLT_Type *)(base))->CICF_CNFG)
#define PPCA_ATOP_AFLT_CICF_DOUT(base)                          (((PPCA_ATOPSS_ADC_GRP_AFLT_Type *)(base))->CICF_DOUT)
#define PPCA_ATOP_AFLT_CICF_UB_TH(base)                         (((PPCA_ATOPSS_ADC_GRP_AFLT_Type *)(base))->CICF_UB_TH)
#define PPCA_ATOP_AFLT_CICF_LB_TH(base)                         (((PPCA_ATOPSS_ADC_GRP_AFLT_Type *)(base))->CICF_LB_TH)
#define PPCA_ATOP_AFLT_AVGF_CTL(base)                           (((PPCA_ATOPSS_ADC_GRP_AFLT_Type *)(base))->AVGF_CTL)
#define PPCA_ATOP_AFLT_AVGF_CNFG(base)                          (((PPCA_ATOPSS_ADC_GRP_AFLT_Type *)(base))->AVGF_CNFG)
#define PPCA_ATOP_AFLT_AVGF_DOUT(base)                          (((PPCA_ATOPSS_ADC_GRP_AFLT_Type *)(base))->AVGF_DOUT)
#define PPCA_ATOP_AFLT_LIF_CNFG(base)                           (((PPCA_ATOPSS_ADC_GRP_AFLT_Type *)(base))->LIF_CNFG)
#define PPCA_ATOP_AFLT_LIF_DOUT(base)                           (((PPCA_ATOPSS_ADC_GRP_AFLT_Type *)(base))->LIF_DOUT)
#define PPCA_ATOP_AFLT_MED_CNFG(base)                           (((PPCA_ATOPSS_ADC_GRP_AFLT_Type *)(base))->MED_CNFG)
#define PPCA_ATOP_AFLT_MED_DOUT(base)                           (((PPCA_ATOPSS_ADC_GRP_AFLT_Type *)(base))->MED_DOUT)
#define PPCA_ATOP_AFLT_ADC_MIN_MAX(base)                        (((PPCA_ATOPSS_ADC_GRP_AFLT_Type *)(base))->ADC_MIN_MAX)


/*******************************************************************************
*            PPCA ATOP DCSG
*******************************************************************************/
#define PPCA_ATOP_DCSG_TEST_OFFSET                 0x0C

#define PPCA_ATOP_DCSG_CTL(base)                                (((PPCA_ATOPSS_DCSG_GRP_DCSG_SLICE_Type *)(base))->DCSG_CTL)
#define PPCA_ATOP_DCSG_CNFG(base)                               (((PPCA_ATOPSS_DCSG_GRP_DCSG_SLICE_Type *)(base))->DCSG_CNFG)
#define PPCA_ATOP_DCSG_TH(base)                                 (((PPCA_ATOPSS_DCSG_GRP_DCSG_SLICE_Type *)(base))->DCSG_TH)
#define PPCA_ATOP_DCSG_DIFF_CALOFFSET(base)                     (((PPCA_ATOPSS_DCSG_GRP_DCSG_SLICE_Type *)(base))->DCSG_DIFF_CALOFFSET)
#define PPCA_ATOP_DCSG_SE_CALOFFSET(base)                       (((PPCA_ATOPSS_DCSG_GRP_DCSG_SLICE_Type *)(base))->DCSG_SE_CALOFFSET)
#define PPCA_ATOP_DCSG_DIFF_CALGAIN_1(base)                     (((PPCA_ATOPSS_DCSG_GRP_DCSG_SLICE_Type *)(base))->DCSG_DIFF_CALGAIN_1)
#define PPCA_ATOP_DCSG_DIFF_CALGAIN_2(base)                     (((PPCA_ATOPSS_DCSG_GRP_DCSG_SLICE_Type *)(base))->DCSG_DIFF_CALGAIN_2)
#define PPCA_ATOP_DCSG_SE_CALGAIN(base)                         (((PPCA_ATOPSS_DCSG_GRP_DCSG_SLICE_Type *)(base))->DCSG_SE_CALGAIN)

/*******************************************************************************
*            PPCA ATOP DCSG_SLGEN
*******************************************************************************/

#define PPCA_ATOP_DCSG_SLGEN_CTL(base)                                (((PPCA_ATOPSS_DCSG_GRP_DCSG_SLGEN_Type *)(base))->DCSG_SLGEN_CTL)
#define PPCA_ATOP_DCSG_SLGEN_CNFG(base)                               (((PPCA_ATOPSS_DCSG_GRP_DCSG_SLGEN_Type *)(base))->DCSG_SLGEN_CNFG)
#define PPCA_ATOP_DCSG_SLGEN_INIT(base)                               (((PPCA_ATOPSS_DCSG_GRP_DCSG_SLGEN_Type *)(base))->DCSG_SLGEN_INIT)
#define PPCA_ATOP_DCSG_SLGEN_TARGET(base)                             (((PPCA_ATOPSS_DCSG_GRP_DCSG_SLGEN_Type *)(base))->DCSG_SLGEN_TARGET)
#define PPCA_ATOP_DCSG_SLGEN_INIT_BUF(base)                           (((PPCA_ATOPSS_DCSG_GRP_DCSG_SLGEN_Type *)(base))->DCSG_SLGEN_INIT_BUF)
#define PPCA_ATOP_DCSG_SLGEN_TARGET_BUF(base)                         (((PPCA_ATOPSS_DCSG_GRP_DCSG_SLGEN_Type *)(base))->DCSG_SLGEN_TARGET_BUF)
#define PPCA_ATOP_DCSG_SLGEN_STEP(base)                               (((PPCA_ATOPSS_DCSG_GRP_DCSG_SLGEN_Type *)(base))->DCSG_SLGEN_STEP)
#define PPCA_ATOP_DCSG_SLGEN_MATCH(base)                              (((PPCA_ATOPSS_DCSG_GRP_DCSG_SLGEN_Type *)(base))->DCSG_SLGEN_MATCH)

/*******************************************************************************
*            PPCA ATOP DCSG_BLANK
*******************************************************************************/

#define PPCA_ATOP_DCSG_BLANK_CTL(base)                                (((PPCA_ATOPSS_DCSG_GRP_DCSG_BLANK_Type *)(base))->DCSG_BLANK_CTL)

/*******************************************************************************
*            PPCA ATOP DCMP
*******************************************************************************/

#define PPCA_ATOP_DCMP_CTL(base)                                (((PPCA_ATOPSS_ADC_GRP_DCMP_Type *)(base))->DCMP_CTL)
#define PPCA_ATOP_DCMP_CNFG(base)                               (((PPCA_ATOPSS_ADC_GRP_DCMP_Type *)(base))->DCMP_CNFG)
#define PPCA_ATOP_DCMP_TRIGGER(base)                            (((PPCA_ATOPSS_ADC_GRP_DCMP_Type *)(base))->DCMP_TRIGGER)
#define PPCA_ATOP_DCMP_TH(base)                                 (((PPCA_ATOPSS_ADC_GRP_DCMP_Type *)(base))->DCMP_TH)
#define PPCA_ATOP_DCMP_ACC_TH(base)                             (((PPCA_ATOPSS_ADC_GRP_DCMP_Type *)(base))->DCMP_ACC_TH)

/*******************************************************************************
*            PPCA ATOP IDAC
*******************************************************************************/

#define PPCA_ATOP_IDAC_CTL(base)                                (((PPCA_ATOPSS_ADC_GRP_IDAC_Type *)(base))->IDAC_CTL)
#define PPCA_ATOP_IDAC_CNFG(base)                               (((PPCA_ATOPSS_ADC_GRP_IDAC_Type *)(base))->IDAC_CNFG)


/*******************************************************************************
*            PPCA ATOP AREF
*******************************************************************************/
#define PPCA_ATOP_AREF_CTL(base)                                (((PPCA_ATOPSS_ADC_GRP_AREF_Type *)(base))->AREF_CTL)
#define PPCA_ATOP_AREF_VDDA_STATUS(base)                        (((PPCA_ATOPSS_ADC_GRP_AREF_Type *)(base))->VDDA_STATUS)
#define PPCA_ATOP_AREF_ANA_CTL(base)                            (((PPCA_ATOPSS_ADC_GRP_AREF_Type *)(base))->AREF_ANA_CTL)
#define PPCA_ATOP_AREF_VREF_TRIM0(base)                         (((PPCA_ATOPSS_ADC_GRP_AREF_Type *)(base))->VREF_TRIM0)
#define PPCA_ATOP_AREF_VREF_TRIM1(base)                         (((PPCA_ATOPSS_ADC_GRP_AREF_Type *)(base))->VREF_TRIM1)
#define PPCA_ATOP_AREF_VREF_TRIM2(base)                         (((PPCA_ATOPSS_ADC_GRP_AREF_Type *)(base))->VREF_TRIM2)
#define PPCA_ATOP_AREF_VREF_TRIM3(base)                         (((PPCA_ATOPSS_ADC_GRP_AREF_Type *)(base))->VREF_TRIM3)
#define PPCA_ATOP_AREF_IZTAT_TRIM0(base)                        (((PPCA_ATOPSS_ADC_GRP_AREF_Type *)(base))->IZTAT_TRIM0)
#define PPCA_ATOP_AREF_IZTAT_TRIM1(base)                        (((PPCA_ATOPSS_ADC_GRP_AREF_Type *)(base))->IZTAT_TRIM1)
#define PPCA_ATOP_AREF_IPTAT_TRIM0(base)                        (((PPCA_ATOPSS_ADC_GRP_AREF_Type *)(base))->IPTAT_TRIM0)
#define PPCA_ATOP_AREF_IPTAT_TRIM1(base)                        (((PPCA_ATOPSS_ADC_GRP_AREF_Type *)(base))->IPTAT_TRIM1)
#define PPCA_ATOP_AREF_ICTAT_TRIM0(base)                        (((PPCA_ATOPSS_ADC_GRP_AREF_Type *)(base))->ICTAT_TRIM0)

/*******************************************************************************
*            PPCA ATOP GPI
*******************************************************************************/

#define PPCA_ATOP_GPI_CTL(base)                                (((PPCA_ATOPSS_ADC_GRP_GPI_Type *)(base))->GPI_CTL)

/*******************************************************************************
*            PPCA ATOP DAC R2R
*******************************************************************************/

#define PPCA_GET_DACR2R_GROUP_NUMBER(base) (((base) == PPCA_ATOPSS_DCSG_GRP0_DAC_R2R)? 0U : 1U)
#define PPCA_ATOP_DAC_CTL(base)                                (((PPCA_ATOPSS_DCSG_GRP_DAC_R2R_Type *)(base))->DAC_CTL)
#define PPCA_ATOP_DAC_CNFG(base)                               (((PPCA_ATOPSS_DCSG_GRP_DAC_R2R_Type *)(base))->DAC_CNFG)
#define PPCA_ATOP_DAC_DOUT(base)                               (((PPCA_ATOPSS_DCSG_GRP_DAC_R2R_Type *)(base))->DAC_DOUT)
#define PPCA_ATOP_DAC_OFFSET_CNFG1(base)                       (((PPCA_ATOPSS_DCSG_GRP_DAC_R2R_Type *)(base))->DAC_OFFSET_CNFG1)
#define PPCA_ATOP_DAC_OFFSET_CNFG2(base)                       (((PPCA_ATOPSS_DCSG_GRP_DAC_R2R_Type *)(base))->DAC_OFFSET_CNFG2)
#define PPCA_ATOP_DAC_OFFSET_CNFG3(base)                       (((PPCA_ATOPSS_DCSG_GRP_DAC_R2R_Type *)(base))->DAC_OFFSET_CNFG3)
#define PPCA_ATOP_DAC_OFFSET_CNFG4(base)                       (((PPCA_ATOPSS_DCSG_GRP_DAC_R2R_Type *)(base))->DAC_OFFSET_CNFG4)
#define PPCA_ATOP_DAC_OFFSET_CNFG5(base)                       (((PPCA_ATOPSS_DCSG_GRP_DAC_R2R_Type *)(base))->DAC_OFFSET_CNFG5)
#define PPCA_ATOP_DAC_GAIN_CNFG1(base)                         (((PPCA_ATOPSS_DCSG_GRP_DAC_R2R_Type *)(base))->DAC_GAIN_CNFG1)
#define PPCA_ATOP_DAC_GAIN_CNFG2(base)                         (((PPCA_ATOPSS_DCSG_GRP_DAC_R2R_Type *)(base))->DAC_GAIN_CNFG2)
#define PPCA_ATOP_DAC_GAIN_CNFG3(base)                         (((PPCA_ATOPSS_DCSG_GRP_DAC_R2R_Type *)(base))->DAC_GAIN_CNFG3)
#define PPCA_ATOP_DAC_GAIN_CNFG4(base)                         (((PPCA_ATOPSS_DCSG_GRP_DAC_R2R_Type *)(base))->DAC_GAIN_CNFG4)
#define PPCA_ATOP_DAC_GAIN_CNFG5(base)                         (((PPCA_ATOPSS_DCSG_GRP_DAC_R2R_Type *)(base))->DAC_GAIN_CNFG5)
#define PPCA_ATOP_BUFFER_OFFSET_1(base)                        (((PPCA_ATOPSS_DCSG_GRP_DAC_R2R_Type *)(base))->BUFFER_OFFSET_1)
#define PPCA_ATOP_BUFFER_OFFSET_2(base)                        (((PPCA_ATOPSS_DCSG_GRP_DAC_R2R_Type *)(base))->BUFFER_OFFSET_2)
...
#define CY_GPIO_IS_IOSS_GPIO(baseAddress)       (true)
