...
#ifndef _CYIP_MXAES_V2_H_
#define _CYIP_MXAES_V2_H_
...
#define MXAES_UNMASKED_INTERNAL_RANGE_SECTION_SIZE 0x00000800UL
#define MXAES_MASKED_USER_RANGE_SECTION_SIZE    0x00000800UL
#define MXAES_MASKED_INTERNAL_RANGE_SECTION_SIZE 0x00000800UL
...
/**
  * \brief AES data registers (x for index of shares; y for index of word) (MXAES_UNMASKED_INTERNAL_RANGE)
  */
typedef struct {
  __IOM uint32_t TEST_1;                        /*!< 0x00000000 AES test register 1 */
   __IM uint32_t RESERVED[511];
} MXAES_UNMASKED_INTERNAL_RANGE_Type;           /*!< Size = 2048 (0x800) */

/**
  * \brief AES key shares (MXAES_MASKED_USER_RANGE)
  */
typedef struct {
...
/**
  * \brief AES Internal registers (MXAES_MASKED_INTERNAL_RANGE)
  */
typedef struct {
   __OM uint32_t TEST_2;                        /*!< 0x00000000 AES second test register */
   __IM uint32_t RESERVED[511];
} MXAES_MASKED_INTERNAL_RANGE_Type;             /*!< Size = 2048 (0x800) */
...
typedef struct {
        ...
        MXAES_UNMASKED_INTERNAL_RANGE_Type UNMASKED_INTERNAL_RANGE; /*!< 0x00000800 AES data registers (x for index of shares; y for index of word) */
        MXAES_MASKED_USER_RANGE_Type MASKED_USER_RANGE; /*!< 0x00001000 AES key shares */
        MXAES_MASKED_INTERNAL_RANGE_Type MASKED_INTERNAL_RANGE; /*!< 0x00001800 AES Internal registers */
} MXAES_Type;                                   /*!< Size = 8192 (0x2000) */
...
/* MXAES_UNMASKED_INTERNAL_RANGE.TEST_1 */
#define MXAES_UNMASKED_INTERNAL_RANGE_TEST_1_TEST0_Pos 0UL
#define MXAES_UNMASKED_INTERNAL_RANGE_TEST_1_TEST0_Msk 0x1UL
#define MXAES_UNMASKED_INTERNAL_RANGE_TEST_1_TEST01_Pos 1UL
#define MXAES_UNMASKED_INTERNAL_RANGE_TEST_1_TEST01_Msk 0x2UL
#define MXAES_UNMASKED_INTERNAL_RANGE_TEST_1_TEST10_Pos 2UL
#define MXAES_UNMASKED_INTERNAL_RANGE_TEST_1_TEST10_Msk 0x4UL
#define MXAES_UNMASKED_INTERNAL_RANGE_TEST_1_TEST101_Pos 5UL
#define MXAES_UNMASKED_INTERNAL_RANGE_TEST_1_TEST101_Msk 0x20UL
#define MXAES_UNMASKED_INTERNAL_RANGE_TEST_1_TEST110_Pos 6UL
#define MXAES_UNMASKED_INTERNAL_RANGE_TEST_1_TEST110_Msk 0x40UL
...
/* MXAES_MASKED_INTERNAL_RANGE.TEST_2 */
#define MXAES_MASKED_INTERNAL_RANGE_TEST_2_TEST_Pos 0UL
#define MXAES_MASKED_INTERNAL_RANGE_TEST_2_TEST_Msk 0xFFFFFFFFUL


#endif /* _CYIP_MXAES_V2_H_ */
