...
#if defined(COMPONENT_SECURE_DEVICE) && defined(CY_PDL_ENABLE_SECURE_AWARE) && (CY_PDL_ENABLE_SECURE_AWARE)
...
#if defined(CY_PDL_ENABLE_SRF_INTEG) && (CY_PDL_ENABLE_SRF_INTEG)
