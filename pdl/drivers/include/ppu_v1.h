...
enum ppu_v1_op_devactive {
    ...
    PPU_V1_OP_DEVACTIVE_INDEPENDENT_COUNT = 4,
...
#define PPU_V1_PWPR_POLICY       ((uint32_t)0x0000000FU)
#define PPU_V1_PWPR_DYNAMIC_EN   ((uint32_t)0x00000100U)
#define PPU_V1_PWPR_OFF_LOCK_EN  ((uint32_t)0x00001000U)
#define PPU_V1_PWPR_OP_POLICY    ((uint32_t)0x000F0000U)
#define PPU_V1_PWPR_OP_DYN_EN    ((uint32_t)0x01000000U)
...
#define PPU_V1_PWSR_PWR_STATUS       ((uint32_t)0x0000000FU)
#define PPU_V1_PWSR_PWR_DYN_STATUS   ((uint32_t)0x00000100U)
#define PPU_V1_PWSR_OFF_LOCK_STATUS  ((uint32_t)0x00001000U)
#define PPU_V1_PWSR_OP_STATUS        ((uint32_t)0x000F0000U)
#define PPU_V1_PWSR_OP_DYN_STATUS    ((uint32_t)0x01000000U)
 ...
 */
#define PPU_V1_UNLK_OFF_UNLOCK       ((uint32_t)0x00000001U)

/*
 * Bit definitions for PWCR
 */
#define PPU_V1_PWCR_DEV_REQ_EN        ((uint32_t)0x000000FFU)
#define PPU_V1_PWCR_DEV_ACTIVE_EN     ((uint32_t)0x0007FF00U)
#define PPU_V1_PWCR_OP_DEV_ACTIVE_EN  ((uint32_t)0xFF000000U)
 ...
 */
#define PPU_V1_IMR_MASK                     ((uint32_t)0x0000003FU)
#define PPU_V1_IMR_STA_POLICY_TRN_IRQ_MASK  ((uint32_t)0x00000001U)
#define PPU_V1_IMR_STA_ACCEPT_IRQ_MASK      ((uint32_t)0x00000002U)
#define PPU_V1_IMR_STA_DENY_IRQ_MASK        ((uint32_t)0x00000004U)
#define PPU_V1_IMR_EMU_ACCEPT_IRQ_MASK      ((uint32_t)0x00000008U)
#define PPU_V1_IMR_EMU_DENY_IRQ_MASK        ((uint32_t)0x00000010U)
#define PPU_V1_IMR_DYN_POLICY_MIN_IRQ_MASK  ((uint32_t)0x00000020U)

/*
 * Bit definitions for AIMR
 */
#define PPU_V1_AIMR_MASK                     ((uint32_t)0x0000001FU)
#define PPU_V1_AIMR_UNSPT_POLICY_IRQ_MASK    ((uint32_t)0x00000001U)
#define PPU_V1_AIMR_DYN_ACCEPT_IRQ_MASK      ((uint32_t)0x00000002U)
#define PPU_V1_AIMR_DYN_DENY_IRQ_MASK        ((uint32_t)0x00000004U)
#define PPU_V1_AIMR_STA_POLICY_PWR_IRQ_MASK  ((uint32_t)0x00000008U)
#define PPU_V1_AIMR_STA_POLICY_OP_IRQ_MASK   ((uint32_t)0x00000010U)

/*
 * Bit definitions for ISR
 */
#define PPU_V1_ISR_MASK                        ((uint32_t)0xFF07FFBFU)
#define PPU_V1_ISR_STA_POLICY_TRN_IRQ          ((uint32_t)0x00000001U)
#define PPU_V1_ISR_STA_ACCEPT_IRQ              ((uint32_t)0x00000002U)
#define PPU_V1_ISR_STA_DENY_IRQ                ((uint32_t)0x00000004U)
#define PPU_V1_ISR_EMU_ACCEPT_IRQ              ((uint32_t)0x00000008U)
#define PPU_V1_ISR_EMU_DENY_IRQ                ((uint32_t)0x00000010U)
#define PPU_V1_ISR_DYN_POLICY_MIN_IRQ          ((uint32_t)0x00000020U)
#define PPU_V1_ISR_OTHER_IRQ                   ((uint32_t)0x00000080U)
#define PPU_V1_ISR_ACTIVE_EDGE_POS             8
#define PPU_V1_ISR_ACTIVE_EDGE_IRQ_MASK        ((uint32_t)0x0007FF00U)
#define PPU_V1_ISR_ACTIVE_EDGE_ACTIVE0_IRQ     ((uint32_t)0x00000100U)
#define PPU_V1_ISR_ACTIVE_EDGE_ACTIVE1_IRQ     ((uint32_t)0x00000200U)
#define PPU_V1_ISR_ACTIVE_EDGE_ACTIVE2_IRQ     ((uint32_t)0x00000400U)
#define PPU_V1_ISR_ACTIVE_EDGE_ACTIVE3_IRQ     ((uint32_t)0x00000800U)
#define PPU_V1_ISR_ACTIVE_EDGE_ACTIVE4_IRQ     ((uint32_t)0x00001000U)
#define PPU_V1_ISR_ACTIVE_EDGE_ACTIVE5_IRQ     ((uint32_t)0x00002000U)
#define PPU_V1_ISR_ACTIVE_EDGE_ACTIVE6_IRQ     ((uint32_t)0x00004000U)
#define PPU_V1_ISR_ACTIVE_EDGE_ACTIVE7_IRQ     ((uint32_t)0x00008000U)
#define PPU_V1_ISR_ACTIVE_EDGE_ACTIVE8_IRQ     ((uint32_t)0x00010000U)
#define PPU_V1_ISR_ACTIVE_EDGE_ACTIVE9_IRQ     ((uint32_t)0x00020000U)
#define PPU_V1_ISR_ACTIVE_EDGE_ACTIVE10_IRQ    ((uint32_t)0x00040000U)
#define PPU_V1_ISR_OP_ACTIVE_EDGE_POS          24
#define PPU_V1_ISR_OP_ACTIVE_EDGE_IRQ_MASK     ((uint32_t)0xFF000000U)
#define PPU_V1_ISR_OP_ACTIVE_EDGE_ACTIVE0_IRQ  ((uint32_t)0x01000000U)
#define PPU_V1_ISR_OP_ACTIVE_EDGE_ACTIVE1_IRQ  ((uint32_t)0x02000000U)
#define PPU_V1_ISR_OP_ACTIVE_EDGE_ACTIVE2_IRQ  ((uint32_t)0x04000000U)
#define PPU_V1_ISR_OP_ACTIVE_EDGE_ACTIVE3_IRQ  ((uint32_t)0x08000000U)
#define PPU_V1_ISR_OP_ACTIVE_EDGE_ACTIVE4_IRQ  ((uint32_t)0x10000000U)
#define PPU_V1_ISR_OP_ACTIVE_EDGE_ACTIVE5_IRQ  ((uint32_t)0x20000000U)
#define PPU_V1_ISR_OP_ACTIVE_EDGE_ACTIVE6_IRQ  ((uint32_t)0x40000000U)
#define PPU_V1_ISR_OP_ACTIVE_EDGE_ACTIVE7_IRQ  ((uint32_t)0x80000000U)

/*
 * Bit definitions for AISR
 */
#define PPU_V1_AISR_MASK                ((uint32_t)0x0000001FU)
#define PPU_V1_AISR_UNSPT_POLICY_IRQ    ((uint32_t)0x00000001U)
#define PPU_V1_AISR_DYN_ACCEPT_IRQ      ((uint32_t)0x00000002U)
#define PPU_V1_AISR_DYN_DENY_IRQ        ((uint32_t)0x00000004U)
#define PPU_V1_AISR_STA_POLICY_PWR_IRQ  ((uint32_t)0x00000008U)
#define PPU_V1_AISR_STA_POLICY_OP_IRQ   ((uint32_t)0x00000010U)
...
#define PPU_V1_MISR_DEVDENY_STATUS_MASK ((uint32_t)0x00FF0000U)

/*
 * Bit definitions for AIDR
 */
#define PPU_V1_AIDR_ARCH_REV_MINOR  ((uint32_t)0x0000000FU)
#define PPU_V1_AIDR_ARCH_REV_MAJOR  ((uint32_t)0x000000F0U)
...
#define PPU_V1_IDR0_NUM_OPMODE        ((uint32_t)0x000000F0U)
