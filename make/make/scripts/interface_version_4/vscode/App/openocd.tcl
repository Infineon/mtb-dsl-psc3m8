...
set ENABLE_CM33_PPCA 1//PSC3_P8 Only//
...
&&_MTB_RECIPE__OPENOCD_TARGET_VAR&&.cm33.ppca0 configure -rtos auto -rtos-wipe-on-reset-halt 1//PSC3_P8 Only//
&&_MTB_RECIPE__OPENOCD_TARGET_VAR&&.cm33.ppca1 configure -rtos auto -rtos-wipe-on-reset-halt 1//triple-core only//
