...
# Older core-make versions don't list advanced_program in their MAKECMDGOALS
# filter, so they set _MTB_CORE__SKIP_BUILD_MK_FILES and never load program.mk.
# Load it here for that case only; newer core-make loads it itself.
ifneq ($(filter advanced_program,$(MAKECMDGOALS)),)
ifneq ($(_MTB_CORE__SKIP_BUILD_MK_FILES),)
