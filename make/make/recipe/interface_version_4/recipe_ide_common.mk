...
# Allow combiner-signer users to set APPNAME as the 'project' property. Keep _MTB_RECIPE__IDE_PRJ_DIR_NAME for BWC
ifeq ($(MTB_COMBINE_SIGN_$(_MTB_RECIPE__IDE_PRJ_DIR_NAME)_HEX_FILES),)
MTB_COMBINE_SIGN_$(_MTB_RECIPE__IDE_PRJ_DIR_NAME)_HEX_FILES:=$(MTB_COMBINE_SIGN_$(APPNAME)_HEX_FILES)
endif
...
# Default: hide the Advanced Programming task. Recipes that support it override to false.
...
_MTB_RECIPE__ADVANCED_PROGRAM_MAKE_CMD?=advanced_program

# Eclipse variant of the advanced_program make command. Unlike the VS Code variant,
# this does NOT include -C because Eclipse's ${cy_prj_path} already resolves to the
# first sub-project directory (not the application root). Quotes use XML entities
# because the value is substituted into ATTR_TOOL_ARGUMENTS of a .launch file.
ifneq (,$(_MTB_RECIPE__IS_MULTI_CORE_APPLICATION))
_MTB_RECIPE__ECLIPSE_ADVANCED_PROGRAM_MAKE_CMD:=advanced_program MTB_APPLICATION_SUBPROJECTS=&quot;$(MTB_APPLICATION_SUBPROJECTS)&quot;
else
_MTB_RECIPE__ECLIPSE_ADVANCED_PROGRAM_MAKE_CMD:=advanced_program
endif
...
recipe_eclipse_common_text_replacement_data_file:
	...
	$(call mtb__file_append,$(_MTB_RECIPE__IDE_COMMON_TEXT_DATA_FILE),&&_MTB_RECIPE__PROBE_INTERFACE&&=$(_MTB_RECIPE__PROBE_INTERFACE))
	$(call mtb__file_append,$(_MTB_RECIPE__IDE_COMMON_TEXT_DATA_FILE),&&_MTB_RECIPE__PROBE_SERIAL&&=$(MTB_PROBE_SERIAL))
	$(call mtb__file_append,$(_MTB_RECIPE__IDE_COMMON_TEXT_DATA_FILE),&&_MTB_RECIPE__ECLIPSE_ADVANCED_PROGRAM_MAKE_CMD&&=$(_MTB_RECIPE__ECLIPSE_ADVANCED_PROGRAM_MAKE_CMD))
	$(call mtb__file_append,$(_MTB_RECIPE__IDE_COMMON_TEXT_DATA_FILE),&&_MTB_RECIPE__OPENOCD_PROBE_FREQUENCY_CMD&&=$(_MTB_RECIPE__OPENOCD_PROBE_FREQUENCY))
...
ifneq (,$(_MTB_RECIPE__IS_MULTI_CORE_APPLICATION))
_MTB_RECIPE__ECLIPSE_CS_DST_BASE_NAME:=.mtbLaunchConfigs/$(_MTB_RECIPE__ECLIPSE_PROJECT_NAME)
else
_MTB_RECIPE__ECLIPSE_CS_DST_BASE_NAME:=.mtbLaunchConfigs/$(_MTB_RECIPE__ECLIPSE_APPLICATION_NAME)
endif
