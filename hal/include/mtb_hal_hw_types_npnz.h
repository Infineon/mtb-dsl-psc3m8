...
#include "mtb_hal_hw_types_npnz_ppca.h"

#if defined(MTB_HAL_DRIVER_AVAILABLE_NPNZ)

//! IP-specific implementation header for NPNA
#define MTB_HAL_NPNZ_IMPL_HEADER           "mtb_hal_npnz_impl.h"
