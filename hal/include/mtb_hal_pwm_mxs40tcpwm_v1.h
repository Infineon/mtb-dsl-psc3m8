...
{
// *SUSPEND-FORMATTING*
    Cy_TCPWM_PWM_CNT_SetPeriod0(obj->tcpwm.grp_cnt_base, count);
// *RESUME-FORMATTING*
    return CY_RSLT_SUCCESS;
}
...
{
// *SUSPEND-FORMATTING*
    Cy_TCPWM_PWM_CNT_SetPeriod1(obj->tcpwm.grp_cnt_base, count);
// *RESUME-FORMATTING*
    return CY_RSLT_SUCCESS;
}
...
{
// *SUSPEND-FORMATTING*
    Cy_TCPWM_PWM_CNT_SetCompare0Val(obj->tcpwm.grp_cnt_base, count);
// *RESUME-FORMATTING*
    return CY_RSLT_SUCCESS;
}
...
{
// *SUSPEND-FORMATTING*
    Cy_TCPWM_PWM_CNT_SetCompare0BufVal(obj->tcpwm.grp_cnt_base, count);
// *RESUME-FORMATTING*
    return CY_RSLT_SUCCESS;
}
...
{
// *SUSPEND-FORMATTING*
    Cy_TCPWM_PWM_CNT_SetCompare1Val(obj->tcpwm.grp_cnt_base, count);
// *RESUME-FORMATTING*
    return CY_RSLT_SUCCESS;
}
...
{
// *SUSPEND-FORMATTING*
    Cy_TCPWM_PWM_CNT_SetCompare1BufVal(obj->tcpwm.grp_cnt_base, count);
// *RESUME-FORMATTING*
    return CY_RSLT_SUCCESS;
}
...
{
// *SUSPEND-FORMATTING*
    Cy_TCPWM_DeadTime deadtime = {.u = count};
    Cy_TCPWM_PWM_CNT_SetDT(obj->tcpwm.grp_cnt_base, deadtime);
// *RESUME-FORMATTING*
    return CY_RSLT_SUCCESS;
}
...
// *SUSPEND-FORMATTING*
    Cy_TCPWM_DeadTime deadtime = {.u = count};
    Cy_TCPWM_PWM_CNT_SetDTBuff(obj->tcpwm.grp_cnt_base, deadtime);
// *RESUME-FORMATTING*
    return CY_RSLT_SUCCESS;
}
...
{
// *SUSPEND-FORMATTING*
    Cy_TCPWM_PWM_CNT_Configure_LineSelect(obj->tcpwm.grp_cnt_base,
